...
//  Happier
//
//  Created by Vicente Noguez Salazar on 24/02/16.
...
struct Data {
    ...
    let phrases = ["Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
    ...
    func returnHappyPhrase() -> String {
        let pos = Int(arc4random()) % phrases.count
        return phrases[pos]
    }
